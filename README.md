...
- **[`docs/`](docs/)** — the human guides: [clients & languages](docs/clients/) (JavaScript/TypeScript, Python, PHP, Go, and more, plus the [HTTP API reference](docs/clients/http-api.md)), [databases & open modes](docs/databases.md), [auth & authorization](docs/auth-and-authz.md), [the Hrana pipeline](docs/hrana.md), and [mTLS in production](docs/mtls-production.md).
